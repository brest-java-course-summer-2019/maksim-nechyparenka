...
public class ProductDaoJdbcImpl implements ProductDao {
    ...
    private final static String FIND_BALANCE_BY_ID =
    ...
    public List<Product> findAll() {
        List<Product> products = namedParameterJdbcTemplate.query(SELECT_ALL, BeanPropertyRowMapper.newInstance(Product.class));
        return products;
    }
    ...
    public Product add(Product product) {
        ...
        parameters.addValue("productReceiptDate", product.getProductReceiptDate());
    ...
    private class ProductRowMapper implements RowMapper<Product> {
        ...
        public Product mapRow(ResultSet resultSet, int i) throws SQLException {
            ...
            product.setProductReceiptDate(resultSet.getString("product_receiptdate"));
